...
export const SHRUTIS = [
  { id: 'V',   kattai: 'V',  note: 'E₃', hz: 164.81, voice: 'vainika' },
...
// Default to Vainika (E₃, ~164.81 Hz) — the warm lower-octave Sa that veena
// players naturally tune to. Matches the Ragas view's default base.
export const DEFAULT_SHRUTI_ID = 'V'
